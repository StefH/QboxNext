...
namespace Microsoft.AspNetCore.Components.WebAssembly.Authentication
{
    ...
    public class JwtAuthenticationMessageHandler : DelegatingHandler
    {
        ...
        public JwtAuthenticationMessageHandler(IAccessTokenProvider provider, NavigationManager navigation)
        {
            _provider = provider;
        ...
        public JwtAuthenticationMessageHandler ConfigureHandler(
