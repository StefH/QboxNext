...
namespace QboxNext.Server.Infrastructure.Azure.Interfaces.Public
{
    public interface IAzureTablesQueryService
    {
        ...
        Task<QboxPagedDataQueryResult<QboxCounterDataValue>> QueryDataAsync([NotNull] string serialNumber, DateTime from, DateTime to, QboxQueryResolution resolution, int addHours);
    }
}