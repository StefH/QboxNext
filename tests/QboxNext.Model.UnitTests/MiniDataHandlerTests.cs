...
namespace QboxNext.Model.Tests
{
    public class MiniDataHandlerTests
    {
        private readonly Mock<IQboxMessagesLogger> _qboxMessagesLoggerMock = new Mock<IQboxMessagesLogger>();
